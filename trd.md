...
is_active
BOOLEAN
If false → 403 Forbidden on all requests
last_login_at
TIMESTAMP
...
Role enforcement
10
CLI (commands + rich output + token handling)
20
Web portal (pages + HTTP-only cookies)
15
API updates (versioning, pagination, export)
10
Rate limiting & logging
5
CI/CD setup
5
Engineering standards (commits, PRs, branches)
5
README completeness
10
Total
